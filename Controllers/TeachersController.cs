...
namespace VirtualSchool.Controllers
{
    ...
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Grade")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Grade")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
